      ...
      <Container className="relative z-10">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {EVENT_CATEGORIES.map((category, index) => (
            <Link key={index} href={`/services/${category.slug}`}>
              <motion.div
                ...
                className="glass glow-border transition-smooth group relative cursor-pointer overflow-hidden rounded-2xl h-full"
              >
                {/* Background gradient */}
